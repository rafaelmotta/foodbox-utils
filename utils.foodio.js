...
var ctrl = function ctrl($scope, $modalInstance, $timeout, Cropper, imgUrlResolved, fileResolved, scopeResolved) {
    ...
    _createClass(StoreCallbacks, [{
      ...
      value: function toOpen() {
        ...
        return $q(function (resolve, reject) {
          ...
          return resolve({ event: 'toOpen', seconds: getDiffFromNow(_this.store.opening_time) });
        });
      }
    }, {
      key: 'toClose',
      value: function toClose() {
        ...
        return $q(function (resolve, reject) {
          ...
          return resolve({ event: 'toClose', seconds: getDiffFromNow(_this2.store.closing_time) });
        });
      }
    }]);
