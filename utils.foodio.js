...
var printManager = function printManager($rootScope, hint, printerApi, orderApi, $uibModal, $templateCache) {
    ...
    _getData: function _getData(options) {
      return new Promise(function (resolve, reject) {
        ...
        if (options.data && options.data.order) {
          orderApi.show(options.data.order.id).then(function (response) {
